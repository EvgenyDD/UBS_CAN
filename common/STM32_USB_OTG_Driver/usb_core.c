							   ...
							   USB_OTG_CORE_ID_TypeDef coreID)
{
	...
	{
		pdev->regs.INEP_REGS[i] = (USB_OTG_INEPREGS *)(baseAddress + USB_OTG_DEV_IN_EP_REG_OFFSET +
													   (i * USB_OTG_EP_REG_OFFSET));
		pdev->regs.OUTEP_REGS[i] = (USB_OTG_OUTEPREGS *)(baseAddress + USB_OTG_DEV_OUT_EP_REG_OFFSET +
														 (i * USB_OTG_EP_REG_OFFSET));
	}
